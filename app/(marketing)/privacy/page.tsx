    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl text-foreground dark:text-foreground">
      ...
      <div className="space-y-8 leading-relaxed">
        <section>
          ...
          <p>
            A <strong>BullVision</strong> assume o compromisso de garantir a privacidade e segurança dos seus dados pessoais.
        ...
        <section>
          ...
          <p>
            A BullVision é a entidade responsável pelo tratamento dos seus dados pessoais no âmbito da prestação dos
        ...
        <section>
          ...
          <p className="mb-4">
            O seu direito à transparência é fundamental para a BullVision. Não vendemos, alugamos ou comercializamos os seus
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>Dados de Faturação e Transações Financeiras (Paddle):</strong> A BullVision <strong>não recolhe nem armazena</strong>
