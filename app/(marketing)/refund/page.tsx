    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl text-foreground dark:text-foreground">
      ...
      <div className="space-y-8 leading-relaxed">
        ...
        <section>
          ...
          <p>
            O Plano PRO da BullValue é classificado legalmente como <strong>conteúdo digital de execução imediata</strong>.
        ...
        <section>
          ...
          <p className="mb-4">
            ...
            custos técnicos de processamento não recuperáveis) e modelos avançados, a BullValue <strong>não efetua
        ...
        <section>
          ...
          <p>
            ...
            pós-compra (por responsabilidade exclusiva da BullValue), deverá contactar imediatamente a equipa
