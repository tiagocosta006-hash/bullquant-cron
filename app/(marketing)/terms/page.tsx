    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl text-foreground dark:text-foreground">
      ...
      <div className="space-y-8 leading-relaxed">
        <section>
          ...
          <p>
            Bem-vindo ao <strong>BullValue</strong>. Os presentes Termos de Serviço ("Termos") regulam o seu acesso e utilização
        ...
        <section>
          ...
          <p className="mb-4 font-semibold text-red-600 dark:text-red-400">
            AVISO CRUCIAL: O BullValue é uma ferramenta de natureza estritamente educacional e informativa. NÃO constituímos,
            sob qualquer forma, aconselhamento financeiro, recomendação de investimento, intermediação financeira ou gestão
            de património.
          </p>
          <p>
            O BullValue não é uma entidade regulada pela Comissão do Mercado de Valores Mobiliários (CMVM) nem por qualquer
        ...
        <section>
          ...
          <p className="mb-4">
            O BullValue opera através de um modelo "Freemium", disponibilizando um Plano FREE limitado e um Plano PRO pago.
          </p>
        ...
        <section>
          ...
          <p className="mb-4">
            ...
            propriedade exclusiva do BullValue. Concorda que, ao utilizar a plataforma, é expressamente <strong>proibido</strong>:
          </p>
          ...
          <p className="mt-4">
            Qualquer violação destas regras de uso aceitável confere ao BullValue o direito de suspender ou terminar
        ...
        <section>
          ...
          <p>
            ...
            O utilizador aceita estes riscos tecnológicos e exime o BullValue de qualquer responsabilidade por eventuais
